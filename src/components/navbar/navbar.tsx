...
const NavBar = (props: NavBarProps) => {
  ...
  return (
    <div className="sticky top-0">
      <div className="relative z-20 m-0 flex h-[50px] items-center justify-between gap-5 bg-green-400 p-[1rem] px-0">
        <div className="flex h-[22px] justify-center">
          <img src={logo} alt="logo" />
        </div>

        <div className="mr-4 hidden rounded-br-lg rounded-tl-lg border border-solid border-black py-1 md:flex">
