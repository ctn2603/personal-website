...
👉 **Navigation Bar**: Includes a 3D desktop model easily customizable to suit specific needs.

👉 **Landing Page**: Includes a 3D desktop model easily customizable to suit specific needs.
...
👉 **Vertical Timeline**: Generate stars progressively at random positions using Three.js for background display.
